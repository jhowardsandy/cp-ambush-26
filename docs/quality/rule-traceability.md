...
| ATK-DIR-001 | accepted | `rulebook/direct-attacks.md` | Legal direct-fire, moving-target/out-of-range completion, blocked-resolution, invalid-profile, and friendly-target tests | `GR-ATK-001` guaranteed direct-fire golden replay. |
