...
| ATK-DIR-001 | accepted | `rulebook/direct-attacks.md` | Legal direct-fire, blocked-resolution, invalid-profile, and friendly-target tests | Add direct-fire golden replay before the first attack profile is expanded. |
