...
- [~] Milestone 5 combat — named direct fire, target-tile cover and armor mitigation, targeted healing/inventory/ammunition, incapacitation, event calculations, and golden replay implemented; blast/projectile rules and richer weapons remain deferred.
