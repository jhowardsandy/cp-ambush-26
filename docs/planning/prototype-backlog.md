...
- [~] Milestone 5 combat — named direct fire, target-tile cover and armor mitigation, deterministic tile-targeted area attacks, targeted healing/inventory/ammunition, incapacitation, and event calculations implemented; visual ballistics, persistent hazards, richer weapons, and golden area replay remain deferred.
...
- [~] Player-authored unit selection and order editing — all four Blue units can build routed/manual movement, targeted attacks/heals, overwatch sequences, and adjacent posture changes with AP/tick/conflict previews; richer conditional orders and drag/edit UX remain deferred.
- [~] Deterministic, explainable PvE enemy planner — observation-safe attack/heal/cover/scout behavior, authored rally objectives, and a one-tile move-then-attack sequence implemented; role-aware tactical policy, longer multi-action planning, objectives, posture, reactions, and doctrine selection remain deferred.
