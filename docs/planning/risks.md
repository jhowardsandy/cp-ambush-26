...
- Implemented rules intentionally remain narrow: direct fire is guaranteed hit once legal; accuracy, cover, armor, ammunition, area effects, and reaction fire remain unresolved risks rather than implicit behavior.
